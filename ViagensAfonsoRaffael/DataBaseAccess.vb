...
Public Class DataBaseAccess
    ...
    Public Function ConnectionString() As String
        ...
        Dim SCLagostim = "Data Source=10.30.10.2,62555;Initial Catalog=RaffaAfonso;User ID=EFAafonso;Password=123.Abc##;"
        'Dim SCLagostimExterna = "Data Source=62.28.39.135,62444;Initial Catalog=EFAafonso;User ID=EFAafonso;Password=Abc.123##"
