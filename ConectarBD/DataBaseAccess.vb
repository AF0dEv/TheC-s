...
Public Class DataBaseAccess
    ...
    Public Function ConnectionString() As String
        ...
        'Dim SCLagostimExterna = "Data Source=62.28.39.135,62444;Initial Catalog=adamastor2022;User ID=sa;Password=123.Abc##;"
        Dim SCLagostim = "Data Source=10.30.10.1,62444;Initial Catalog=EFAAFONSOF12;User ID=EFAafonso;Password=Abc.123##"
