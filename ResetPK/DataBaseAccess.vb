...
Public Class DataBaseAccess
    ...
    Public Function ConnectionString() As String
        ...
        Dim SCLagostim = "Data Source=10.30.10.2,62555;Initial Catalog=CR7;User ID=EFAafonso;Password=123.Abc##;"
        'Dim SCLagostimExterna = "Data Source=62.28.39.135,62444;Initial Catalog=bdFelippeAfonso_Produtos;User ID=EFAafonso;Password=Abc.123##;"
