...
Public Class DataBaseAccess
    ...
    Public Function ConnectionString() As String
        ...
        Dim SCLeopardo = "Data Source=leopardo\sqlleo;Initial Catalog=adamastor;User ID=sa;Password=123.Abc.@;"

        Dim SCLagostim =
            "Data Source=10.30.10.1,62444;Initial Catalog=adamastor2022;User ID=sa;Password=123.Abc##;"
